...
namespace Cookbook.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult FacebookLogin(string token)
        {
            ...
            try
            {
                var json = client.DownloadString(String.Format("http://server-17.apphb.com/api/NguoiDung/Get/{0}", id));
            ...
            catch
            {
                ...
                Account account = new Account("htmqjk7ze", "125682738555298", "IZ7vYBgu43O930DMl3fKbtxLCz8");
